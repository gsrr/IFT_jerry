...
def callSetup(deployMnt):
    ...
    setup(
        ...
        data_files=[
            ...
            (deployMnt + '/NAS/misc/HAAgent/Lib/[lib_position]', ['hapack/[module_name_upper]Lib.py']),
            (deployMnt + '/NAS/misc/HAAgent/Lib/[lib_position]', ['hapack/restore[module_name_upper].py']),
